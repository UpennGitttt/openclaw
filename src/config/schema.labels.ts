...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.policy": "Scoped Tool Policies",
  "tools.policy.tools": "Core Tool Policy",
  "tools.policy.plugins": "Plugin Tool Policy",
  "tools.policy.mcp": "MCP Tool Policy",
  "agents.list[].tools.profile": "Agent Tool Profile",
  "agents.list[].tools.alsoAllow": "Agent Tool Allowlist Additions",
  "agents.list[].tools.policy": "Agent Scoped Tool Policies",
  "agents.list[].tools.policy.tools": "Agent Core Tool Policy",
  "agents.list[].tools.policy.plugins": "Agent Plugin Tool Policy",
  "agents.list[].tools.policy.mcp": "Agent MCP Tool Policy",
  ...
  "agents.defaults.systemPrompt": "Default System Prompt",
  "agents.defaults.systemPromptMode": "System Prompt Mode",
  "agents.defaults.promptContext": "Default Prompt Context",
  "agents.defaults.promptContext.files": "Default Prompt Context Files",
  ...
  "agents.list[].systemPromptMode": "Agent System Prompt Mode",
  "agents.list[].promptContext": "Agent Prompt Context",
  "agents.list[].promptContext.files": "Agent Prompt Context Files",
